...
def nuclear_strip(path, is_hub=False):
    ...
    # --- 1. PHYSICAL STRIP (Nuking the DOM elements completely) ---
    patterns = [
    ...
    payload = """
<style id="nuclear-precision-v27">
...
print("TOTAL PHYSICAL STRIP V27: Bloat nuked, themes preserved.")
