...
style = """<style id="nuclear-style-v9">
...
/* Fix loader flash AND stuck at 45% by NOT touching its visibility/opacity so ExtJS code can find it */
...
/* 2. Reclaim vertical space without stretching the canvas! */
...
script = """<script id="nuclear_ui_v9">
...
print("V9 Editor UI Deployed - Testing layout shifting")
