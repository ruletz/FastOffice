...
def strip_and_optimize(path, is_hub=False):
    ...
    # --- 1. PHYSICAL REMOVAL OF BLOAT ---
    # Targets: Logo, Text, Branding containers
    ...
    # --- 2. PRECISION CSS & JS ---
    nuclear_css = """
<style id="nuclear-precision-v23">
/* HEADER UNIFICATION */
...
/* HOMESCREEN BIG ICONS (TRANSPARENT BG TO PRESERVE THEME) */
.document-creation-grid { display: flex !important; align-items: center !important; gap: 32px !important; justify-content: center !important; padding: 104px 112px !important; height: 100% !important; width: 100% !important; position: absolute; top: 0; left: 0; z-index: 99; background: transparent !important; }
...
"""
    ...
    nuclear_js = """
<script id="nuclear-final-logic-v23">
(function() {
    // 1. RUST ENGINE
    ...
    // 3. SPEED: Adjust waitSeconds for requirejs
...
print("DEFINITIVE OPTIMIZATION COMPLETE: Bloat stripped, native theme preserved, speed maximized.")
