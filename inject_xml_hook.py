...
async function BootRust() {{
    ...
    console.log('[RUST] WASM Engine loaded. Hooking into AscCommon Base64 and XML OOXML parsing...');
...
print('Rust Engine V3 (Base64 + Regex XML Hook) injected into index.html!')
