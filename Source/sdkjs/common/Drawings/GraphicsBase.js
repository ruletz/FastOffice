...
(function(window, undefined){
	...
	// Host-controlled feature gates for "minimal" builds.
	// Defaults preserve upstream behavior unless explicitly overridden by the host app.
	window['AscCommon'].EditorFeatures = window['AscCommon'].EditorFeatures || {};
